...
class VideoIndexerClient:
    ...
    def upload_url_async(self, video_name:str, video_url:str, excluded_ai:Optional[list[str]]=None,
        ...
        response = requests.post(url, params=params,headers={'Accept-Language': 'ja-JP'})
    ...
    def file_upload_async(self, media_path:str, video_name:Optional[str]=None, excluded_ai:Optional[list[str]]=None,
        ...
        response = requests.post(url, params=params, files={'file': open(media_path,'rb')},headers={'Accept-Language': 'ja'})
    ...
    def wait_for_index_async(self, video_id:str, language:str='Japanese', timeout_sec:Optional[int]=None) -> None:
        '''
